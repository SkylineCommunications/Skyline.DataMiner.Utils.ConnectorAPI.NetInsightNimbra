namespace Skyline.DataMiner.Utils.ConnectorAPI.NetInsightNimbra.Results
{
    ...
    /// <summary>
    /// Represents the result of a Set Forwarding Function request sent to the NetInsight Nimbra device.
    /// </summary>
    public class SetForwardingFunctionResult : BaseResult
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SetForwardingFunctionResult"/> class.
        /// </summary>
